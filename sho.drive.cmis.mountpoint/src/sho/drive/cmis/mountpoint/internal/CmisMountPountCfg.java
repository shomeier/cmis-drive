...
@ObjectClassDefinition(name = CmisMountPointCfg.CONFIG_NAME, description = "Configuration for CMIS Drive MountPoint")
@interface CmisMountPointCfg
{
	static final String CONFIG_NAME = "CMIS Drive MountPoint Config";
